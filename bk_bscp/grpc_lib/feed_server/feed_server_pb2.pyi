...
class FileMeta(_message.Message):
    __slots__ = ("id", "commit_id", "commit_spec", "config_item_spec", "config_item_attachment", "repository_spec")
    ...
    def __init__(self, id: _Optional[int] = ..., commit_id: _Optional[int] = ..., commit_spec: _Optional[_Union[_commit_pb2.CommitSpec, _Mapping]] = ..., config_item_spec: _Optional[_Union[_config_item_pb2.ConfigItemSpec, _Mapping]] = ..., config_item_attachment: _Optional[_Union[_config_item_pb2.ConfigItemAttachment, _Mapping]] = ..., repository_spec: _Optional[_Union[RepositorySpec, _Mapping]] = ...) -> None: ...
...
class PullAppFileMetaResp(_message.Message):
    __slots__ = ("release_id", "repository", "file_metas", "pre_hook", "post_hook")
    ...
    def __init__(self, release_id: _Optional[int] = ..., repository: _Optional[_Union[Repository, _Mapping]] = ..., file_metas: _Optional[_Iterable[_Union[FileMeta, _Mapping]]] = ..., pre_hook: _Optional[_Union[_hook_pb2.HookSpec, _Mapping]] = ..., post_hook: _Optional[_Union[_hook_pb2.HookSpec, _Mapping]] = ...) -> None: ...
...
class KvMeta(_message.Message):
    __slots__ = ("key", "kv_type", "revision", "kv_attachment")
    KEY_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, key: _Optional[str] = ..., kv_type: _Optional[str] = ..., revision: _Optional[_Union[_base_pb2.Revision, _Mapping]] = ..., kv_attachment: _Optional[_Union[_kvs_pb2.KvAttachment, _Mapping]] = ...) -> None: ...
