...
class Kv(_message.Message):
    __slots__ = ("id", "kv_state", "spec", "attachment", "revision")
    ...
    def __init__(self, id: _Optional[int] = ..., kv_state: _Optional[str] = ..., spec: _Optional[_Union[KvSpec, _Mapping]] = ..., attachment: _Optional[_Union[KvAttachment, _Mapping]] = ..., revision: _Optional[_Union[_base_pb2.Revision, _Mapping]] = ...) -> None: ...

class KvSpec(_message.Message):
    __slots__ = ("key", "kv_type", "value")
    ...
    kv_type: str
    value: str
    def __init__(self, key: _Optional[str] = ..., kv_type: _Optional[str] = ..., value: _Optional[str] = ...) -> None: ...
